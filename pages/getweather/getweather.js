const APIKEY = "d0944cb3b62f42bc9b6e680c139db67f";// 填入你申请的KEY
Page({
   ...
   /* wx.showLoading({
    ...
    wx.request({
      ...
      success(result) {
        ...
        //console.log(res)   运行到这里
        //console.log(啦啦啦)
        res.hourly.forEach(function (item) {     //forEach 未定义
    ...
    wx.request({
      ...
      success(result) {
        ...
        res.daily.forEach(function (item) {   //forEach遍历数组 应该先判断是否存在
